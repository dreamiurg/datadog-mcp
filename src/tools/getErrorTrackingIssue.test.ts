...
describe("getErrorTrackingIssue", () => {
    ...
    describe("execute", () => {
        it("throws if not initialized", async () => {
            ...
            await expect(fresh.execute({ issue_id: "abc123" })).rejects.toThrow("getErrorTrackingIssue not initialized");
        });
        ...
        it("makes correct API call and returns results", async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining("/api/v2/error-tracking/issues/abc123"), expect.objectContaining({ method: "GET" }));
